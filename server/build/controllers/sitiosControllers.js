...
var SitiosControllers = /** @class */ (function () {
    function SitiosControllers() {
    }
    SitiosControllers.prototype.getOne = function (req, res) {
    ...
    SitiosControllers.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query('INSERT INTO sitios set ?', [req.body])];
                    case 1:
                        _a.sent();
    ...
    SitiosControllers.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, sitio;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SitiosControllers.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, sitio, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SitiosControllers.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, database_1.default.query('SELECT * FROM sitios')];
                    case 1:
                        words = _a.sent();
    ...
    SitiosControllers.prototype.searchSitios = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return SitiosControllers;
}());
var sitiosControllers = new SitiosControllers;
exports.default = sitiosControllers;
