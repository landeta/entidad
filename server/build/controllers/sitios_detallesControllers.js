...
var SitiosDetallesControllers = /** @class */ (function () {
    function SitiosDetallesControllers() {
    }
    SitiosDetallesControllers.prototype.getOne = function (req, res) {
    ...
    SitiosDetallesControllers.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SitiosDetallesControllers.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, sitio;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SitiosDetallesControllers.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, sitio, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SitiosDetallesControllers.prototype.list = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SitiosDetallesControllers.prototype.searchSitios = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return SitiosDetallesControllers;
}());
var sitiosDetallesControllers = new SitiosDetallesControllers;
exports.default = sitiosDetallesControllers;
